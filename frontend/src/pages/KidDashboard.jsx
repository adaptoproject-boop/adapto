                    ...
                    >
                        ...
                        <div className="flex flex-col lg:flex-row items-center gap-12 relative z-10">
                            ...
                            <motion.img 
                                ...
                                alt="Keystone School of Engineering" 
                                className="w-40 h-40 object-contain rounded-full border-4 border-white shadow-xl bg-white"
                                animate={{ y: [0, -10, 0] }}
                                                            ...
                                                            >
                                                                <div>
                                                                    <div className="flex items-center justify-between mb-4">
                                                                        ...
                                                                        <span className={`text-[8px] font-black uppercase tracking-widest px-2 py-0.5 rounded-full border ${lesson.difficulty?.toLowerCase() === 'hard' ? 'bg-red-50 text-red-500 border-red-100' :
                                            ...
                                            <div className={`group relative bg-white p-6 rounded-[35px] border-b-8 border-gray-100 hover:border-indigo-100 shadow-sm hover:shadow-xl transition-all h-full`}>
                                                ...
                                                <div className="flex items-center justify-between mt-4">
                                                    <div className="flex flex-col">
                                                        ...
                                                        <span className={`text-[8px] font-black uppercase mt-1 px-2 py-0.5 rounded-full border ${subject.currentLevel === 'hard' ? 'bg-red-50 text-red-500 border-red-100' :
                                    ...
                                    {ALL_BADGES.map((badge, idx) => {
                                        ...
                                        return (
                                            <motion.div
                                                ...
                                                className={`p-5 rounded-3xl border transition-all duration-300 relative ${isUnlocked
                                            ...
                                            >
                                                ...
                                                <div className="flex justify-center mb-3">
                                                    <div className={`w-16 h-16 rounded-full flex items-center justify-center text-3xl shadow-inner relative border-4 ${isUnlocked
